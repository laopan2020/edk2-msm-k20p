[Defines] 
   ...
   DEVICE_DXE_FV_COMPONENTS       = Platform/Xiaomi/sm8150/raphael.fdf.inc 
 ...
 [PcdsFixedAtBuild.common] 
   ...
   gRenegadePkgTokenSpaceGuid.PcdDeviceProduct|"MI 9T PRO" 
   gRenegadePkgTokenSpaceGuid.PcdDeviceCodeName|"raphael"
